...
public class ExtentManager {
    ...
    private static String fileSeperator = System.getProperty("file.separator"); //to get system separator format
    private static String reportFilepath = System.getProperty("user.dir") +fileSeperator+ "TestReport_Extent";
